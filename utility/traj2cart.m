function cart = traj2cart(Xtraj,mixes,tcart_flag)
% traj2cart transforms the compositional positions along a linear 
% trajectory given in "Xtraj" with end point mole fractions in "mixes" to 
% cartesian coordinates outputted in "cart"
%
